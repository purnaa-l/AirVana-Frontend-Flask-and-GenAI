...
st.markdown("<h3>Aira: AirSphere’s intuitive podcast engine – immersive, eloquent, effortless.</h3>", unsafe_allow_html=True)
styles = {
...
if st.button("🎙 Generate Podcast Now!"):
    with st.spinner("Aira is crafting your perfect audio experience..."):
        ...
        prompt = f"""
        You are Aira, AirSphere’s intelligent podcast voice. {styles[style]}.
        Topic: {query}.
